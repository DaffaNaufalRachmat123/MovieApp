...
android {
    ...
    productFlavors {
        create("development"){
            ...
            buildConfigField("String" , "BASE_API_KEY" , buildEnvironmentProperties["BASE_API_KEY"].toString())
            buildConfigField("String" , "BASE_IMAGE_URL" , buildEnvironmentProperties["BASE_IMAGE_URL"].toString())
            buildConfigField("String" , "BASE_YOUTUBE_IMAGE_URL" , buildEnvironmentProperties["BASE_YOUTUBE_IMAGE_URL"].toString())
        }
        create("beta"){
            dimension = "environment"
