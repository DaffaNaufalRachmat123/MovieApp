package com.movie.common.widget
...
class LoadingDots : LinearLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        mDotsColor = a.getColor(R.styleable.LoadingDots_LoadingDots_dots_color, context.resources.getColor(
            com.movie.uiresources.R.color.teal_200))
